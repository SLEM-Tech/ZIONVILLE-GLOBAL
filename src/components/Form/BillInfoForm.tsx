							...
							<div className='grid md:grid-cols-2 gap-3 sm:gap-8'>
								<div>
									...
									<Field
										...
										className={`w-full p-2 sm:py-3 font-[400] text-base rounded-md border border-secondary-800 placeholder:text-black/60 outline-none focus:border-secondary-800 transition-[.5] ease-in ${
								...
								<div>
									...
									<div className='relative'>
										<Field
											as='select'
											name='state'
											className='w-full p-2 sm:py-3 font-[400] text-base rounded-md border border-secondary-800 placeholder:text-black/60 outline-none focus:border-secondary-800 transition-[.5] ease-in appearance-none cursor-pointer'
											onChange={(event: any) => {
												handleStateChange(
