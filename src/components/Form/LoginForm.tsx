				...
				<Form className='flex flex-col gap-2 md:gap-4'>
					<div>
						...
						<Field
							...
							className={`w-full px-2 py-2 md:py-3 placeholder:text-gray-500 text-base md:text-sm rounded-md border border-secondary-800 outline-none transition-[.5] ease-in focus:border-transparent focus:ring-1 focus:ring-primaryColor-100 ${
					...
					<div>
						...
						<div className='relative'>
							<Field
								...
								className={`w-full px-2 py-2 md:py-3 placeholder:text-gray-500 text-base md:text-sm rounded-md border border-secondary-800 outline-none focus:border-transparent transition-[.5] ease-in focus:ring-1 focus:ring-primaryColor-100 ${
