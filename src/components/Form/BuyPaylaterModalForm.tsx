				...
				<Form className='flex flex-col gap-2 sm:gap-3'>
					<div>
						<Field
							...
							id='fullName'
							name='fullName'
							className='w-full px-2 py-2 md:py-3 font-[400] text-base md:text-sm rounded-md border border-[#4D4D4D]outline-none focus:border-secondary-800 transition-[.5] ease-in bg-gray'
						/>
					</div>
					<div>
						<label
						...
						<Field
							...
							className='w-full px-2 py-2 md:py-3 font-[400] text-base md:text-sm rounded-md border border-secondary-800 outline-none focus:border-secondary-800 transition-[.5] ease-in'
						/>
					</div>
					...
					<div>
						...
						<div className='relative'>
							<Field
								as='select'
								name='state'
								className='w-full px-2 py-2 md:py-3 font-[400] text-xs md:text-base rounded-md border border-secondary-800 placeholder:text-black/60 outline-none focus:border-secondary-800 transition-[.5] ease-in appearance-none cursor-pointer'
								onChange={(event: any) => {
									handleStateChange(
