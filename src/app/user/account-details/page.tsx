										...
										<div className='grid grid-cols-6 gap-6'>
											...
											<div className='col-span-6 sm:col-span-3 text-secondary-300'>
												...
												<input
													...
													className={`w-full px-2 py-2 md:py-3 font-[400] text-base md:text-sm rounded-md border border-secondary-800 outline-none focus:border-secondary-800 transition-[.5] ease-in bg-slate-100 cursor-not-allowed`}
												/>
											</div>
										</div>
