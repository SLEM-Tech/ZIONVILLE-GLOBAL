							...
							<div className='grid grid-cols-6 gap-6'>
								<div className='col-span-6 sm:col-span-6 max-w-[400px]'>
									...
									<Field
										...
										className={`w-full px-2 py-2 md:py-3 font-[400] text-base md:text-sm rounded-md border border-secondary-800 outline-none focus:border-secondary-800 transition-[.5] ease-in cursor-not-allowed bg-slate-100 ${
								...
								<div className='col-span-6 sm:col-span-6 max-w-[400px]'>
									...
									<div className='relative'>
										<Field
											...
											className={`w-full px-2 py-2 md:py-3 font-[400] text-base md:text-sm rounded-md border border-secondary-800 outline-none focus:border-transparent transition-[.5] ease-in focus:ring-1 focus:ring-primaryColor-100 ${
